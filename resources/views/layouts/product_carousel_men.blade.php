<!-- Carousel - men -->
@if(\App\Models\Product::where('sex', 'Men')->count() > 0)
  <h2 class="caregoryheader">Men</h2>

  <!-- Carousel for max-width: 999px -->
  <div id="carousel1" class="carousel slide">
    <div class="carousel-inner">
      @foreach($men_products as $index => $product)
        @if($index % 4 == 0)
        ...
        @endif
              ...
              @if($index % 4 == 3 || $index == count($men_products) - 1)
            </div>
          </div>
              @endif
      @endforeach
    ...
    <div class="carousel-inner">
      @foreach($men_products as $index => $product)
        ...
        @endif
              ...
              @if($index % 3 == 2 || $index == count($men_products) - 1)
            </div>
          </div>
              @endif
        @endforeach
    ...
    <div class="carousel-inner">
      @foreach($men_products as $index => $product)
        ...
        @endif
              ...
              @if($index % 2 == 1 || $index == count($men_products) - 1)
            </div>
          </div>
              @endif
      @endforeach
